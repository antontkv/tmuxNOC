...
Keyboard shortcuts after prefix key `C-a`.
...
| `j`   | Select next pane                      |
| `k`   | Select previous pane                  |
| `C-o` | Swap pane positions                   |
| `H`   | Move window to the left               |
| `L`   | Move window to the right              |
| `z`   | Focus pane to full size               |
| `x`   | Close pane                            |
| `X`   | Close window                          |
| `C-x` | Close all other windows               |
| `Q`   | Close session                         |
| `d`   | Detach from session                   |
| `D`   | Detach all other clients from session |
| `/`   | Search down                           |
| `?`   | Search up                           |
...
| Key                     | Description |
| ----------------------- | ----------- |
| `Dragging window title` | Move window |
